class Game {
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      //Programe que...
      /*Se a posição do player no eixo y, for maior que a finishline
  ...
  handleFuel(index) {
    ...
    /*Programe que...
    Se o o combustivel do jogador for maior 0 e ele estiver movendo
    diminua o combustivel em 0.3
    lembrando que a variável que guarda o combustivel do jogador
    se chama 'player.fuel'*/
    if (??? && this.playerMoving) {
      ??? -= ???;
    }
    ...
    e acontecerá a função 'this.gameOver()';*/
    if (player.fuel <= 0) {
      gameState = 2;
      this.gameOver();
    }
...
handlePlayerControls() {
  if (keyIsDown(UP_ARROW)) {
/*Coloque o 'this.playerMoving ', como verdadeiro, pois ele habilita que o jogador está se movendo*/
    this.playerMoving = ???; 
